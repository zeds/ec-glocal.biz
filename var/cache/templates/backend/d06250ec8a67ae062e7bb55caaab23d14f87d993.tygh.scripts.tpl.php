<?php /* Smarty version Smarty-3.1.21, created on 2022-05-30 21:07:23
         compiled from "/home/xb870157/ec-glocal.biz/public_html/design/backend/templates/common/scripts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:15706223326294b37b6b31f2-03589717%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd06250ec8a67ae062e7bb55caaab23d14f87d993' => 
    array (
      0 => '/home/xb870157/ec-glocal.biz/public_html/design/backend/templates/common/scripts.tpl',
      1 => 1626244530,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '15706223326294b37b6b31f2-03589717',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6294b37b7455e5_72807676',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6294b37b7455e5_72807676')) {function content_6294b37b7455e5_72807676($_smarty_tpl) {?><?php if (!is_callable('smarty_block_scripts')) include '/home/xb870157/ec-glocal.biz/public_html/app/functions/smarty_plugins/block.scripts.php';
...
<?php if ((defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null)=='ja') {?>
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['controller']=='profiles'||$_smarty_tpl->tpl_vars['runtime']->value['controller']=='companies'||$_smarty_tpl->tpl_vars['runtime']->value['controller']=='suppliers'||$_smarty_tpl->tpl_vars['runtime']->value['controller']=='order_management') {?>
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('inline_script', array()); $_block_repeat=true; echo smarty_block_inline_script(array(), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php echo '<script'; ?>
...
>
            ...
            if($("input[name='user_data[b_zipcode]']").length)
                $("input[name='user_data[b_zipcode]']").attr('onKeyUp', "AjaxZip3.zip2addr(this,'','user_data[b_state]','user_data[b_city]','','user_data[b_address]');");
            if($("input[name='user_data[s_zipcode]']").length)
                $("input[name='user_data[s_zipcode]']").attr('onKeyUp', "AjaxZip3.zip2addr(this,'','user_data[s_state]','user_data[s_city]','','user_data[s_address]');");
            if($("input[name='company_data[zipcode]']").length)
                $("input[name='company_data[zipcode]']").attr('onKeyUp', "AjaxZip3.zip2addr(this,'','company_data[state]','company_data[city]','','company_data[address]');");
            if($("input[name='supplier_data[zipcode]']").length)
                $("input[name='supplier_data[zipcode]']").attr('onKeyUp', "AjaxZip3.zip2addr(this,'','supplier_data[state]','supplier_data[city]','','supplier_data[address]');");
            if($("input[name='update[33]']").length)
                $("input[name='update[33]']").attr('onKeyUp', "AjaxZip3.zip2addr(this,'','update[25]','update[26]','','update[27]');");
