<?php /* Smarty version Smarty-3.1.21, created on 2022-05-30 21:33:47
         compiled from "/home/xb870157/ec-glocal.biz/public_html/design/backend/templates/common/daterange_picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2822599496294b9ab056bc6-20289726%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dc381d0a7ae6e7316dcdf8fb8208811064f078f2' => 
    array (
      0 => '/home/xb870157/ec-glocal.biz/public_html/design/backend/templates/common/daterange_picker.tpl',
      1 => 1626227148,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2822599496294b9ab056bc6-20289726',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6294b9ab08c598_84476228',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6294b9ab08c598_84476228')) {function content_6294b9ab08c598_84476228($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home/xb870157/ec-glocal.biz/public_html/app/functions/smarty_plugins/modifier.date_format.php';
    ...
    <a class="btn-text">
        <span>
            ...
            <?php if ((defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null)=='ja') {?>
                <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['start_date']->value,"%Y/%m/%d"), ENT_QUOTES, 'UTF-8');?>
 — <?php echo htmlspecialchars(smarty_modifier_date_format($_smarty_tpl->tpl_vars['end_date']->value,"%Y/%m/%d"), ENT_QUOTES, 'UTF-8');?>

            <?php } elseif ($_smarty_tpl->tpl_vars['settings']->value['Appearance']['calendar_date_format']=="month_first") {?>
