<?php /* Smarty version Smarty-3.1.21, created on 2022-06-11 13:01:20
         compiled from "/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/blocks/product_filters/components/product_filter_slider.tpl" */ ?>
<?php /*%%SmartyHeaderCode:78190414462a41390780660-77804208%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9fe8c8843cf2a8ec510be2ffff85cd447f6cac6b' => 
    array (
      0 => '/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/blocks/product_filters/components/product_filter_slider.tpl',
      1 => 1653909591,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '78190414462a41390780660-77804208',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62a413907d7fd8_99748179',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62a413907d7fd8_99748179')) {function content_62a413907d7fd8_99748179($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/home/xb870157/ec-glocal.biz/public_html/app/functions/smarty_plugins/function.script.php';
...
<?php if ($_smarty_tpl->tpl_vars['filter']->value['selected_range']) {?>
    <?php $_smarty_tpl->tpl_vars['value'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['filter']->value['current_left']).((string)(defined('FILTERS_HASH_FEATURE_SEPARATOR') ? constant('FILTERS_HASH_FEATURE_SEPARATOR') : null)).((string)$_smarty_tpl->tpl_vars['filter']->value['current_right']), null, 0);?>

    <?php if ($_smarty_tpl->tpl_vars['filter']->value['extra']) {?>
        <?php $_smarty_tpl->tpl_vars['value'] = new Smarty_variable(((string)$_smarty_tpl->tpl_vars['value']->value).((string)(defined('FILTERS_HASH_FEATURE_SEPARATOR') ? constant('FILTERS_HASH_FEATURE_SEPARATOR') : null)).((string)$_smarty_tpl->tpl_vars['filter']->value['extra']), null, 0);?>
    <?php }?>
<?php }?>
    ...
    <p class="ty-price-slider__inputs">
        <bdi class="ty-price-slider__bidi-container">
            ...
            <input type="text"
                ...
                id="slider_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter_uid']->value, ENT_QUOTES, 'UTF-8');?>
_left"
                name="left_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter_uid']->value, ENT_QUOTES, 'UTF-8');?>
"
...
"
                <?php if ($_smarty_tpl->tpl_vars['disable_slider']->value) {?>
                    disabled="disabled"
                <?php }?>
                data-ca-previous-value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['left']->value, ENT_QUOTES, 'UTF-8');?>
"/>
        ...
        <bdi class="ty-price-slider__bidi-container">
            ...
            <input type="text"
                ...
                id="slider_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter_uid']->value, ENT_QUOTES, 'UTF-8');?>
_right"
                name="right_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter_uid']->value, ENT_QUOTES, 'UTF-8');?>
"
...
"
                <?php if ($_smarty_tpl->tpl_vars['disable_slider']->value) {?>
                    disabled="disabled"
                <?php }?>
                data-ca-previous-value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['right']->value, ENT_QUOTES, 'UTF-8');?>
"/>
            <?php echo $_smarty_tpl->tpl_vars['filter']->value['suffix'];?>
