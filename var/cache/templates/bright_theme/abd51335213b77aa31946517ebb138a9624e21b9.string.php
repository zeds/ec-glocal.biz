<?php /* Smarty version Smarty-3.1.21, created on 2022-06-04 23:41:14
         compiled from "abd51335213b77aa31946517ebb138a9624e21b9" */ ?>
<?php /*%%SmartyHeaderCode:1571964568629b6f0a35bff8-02192988%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'abd51335213b77aa31946517ebb138a9624e21b9' => 
    array (
      0 => 'abd51335213b77aa31946517ebb138a9624e21b9',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '1571964568629b6f0a35bff8-02192988',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_629b6f0a361828_35603395',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_629b6f0a361828_35603395')) {function content_629b6f0a361828_35603395($_smarty_tpl) {?><div>
	宿泊施設を選択すると、配送先住所が自動入力されます
</div>

<h3>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H1.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H1(this)">
	<p>S-H1.矢嶋邸  矢嶋様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H2.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H2(this)">
	<p>S-H2.海風</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
...
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y1.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y1(this)">
	<p>S-Y1.第6  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y2.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y2(this)">
	<p>S-Y2.第1ルームA  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y3.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y3(this)">
	<p>S-Y3.第1ルームB  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y4.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y4(this)">
	<p>S-Y4.県立103  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y5.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y5(this)">
	<p>S-Y5.県立104  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
