<?php /* Smarty version Smarty-3.1.21, created on 2022-05-31 06:26:40
         compiled from "/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/views/profiles/components/profile_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:158327751062953690f27eb9-11172896%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0857d9be480fb9ada3b3cb4a906cbefc383a6bd7' => 
    array (
      0 => '/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/views/profiles/components/profile_fields.tpl',
      1 => 1653909591,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '158327751062953690f27eb9-11172896',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_629536912320b2_53651907',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_629536912320b2_53651907')) {function content_629536912320b2_53651907($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_enum')) include '/home/xb870157/ec-glocal.biz/public_html/app/functions/smarty_plugins/modifier.enum.php';
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['value']->value['file_name'], ENT_QUOTES, 'UTF-8');?>
    ...
    <?php } else { ?>  
        ...
        <?php if ((defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null)=='ja'&&($_smarty_tpl->tpl_vars['runtime']->value['controller']=='profiles'||$_smarty_tpl->tpl_vars['runtime']->value['controller']=='checkout'||$_smarty_tpl->tpl_vars['runtime']->value['controller']=='companies')) {?>
            <?php if ($_smarty_tpl->tpl_vars['data_id']->value=='b_zipcode') {?>
                <input <?php if ($_smarty_tpl->tpl_vars['field']->value['autocomplete_type']) {?>x-autocompletetype="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['autocomplete_type'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> type="tel" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'UTF-8');?>
elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');
} else { ?>cm-skip-avail-switch<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['profile_fields']['index']==0) {?> cm-focus<?php }?>" onKeyUp="AjaxZip3.zip2addr(this,'','user_data[b_state]','user_data[b_city]','','user_data[b_address]');" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value) {
echo $_smarty_tpl->tpl_vars['disabled_param']->value;
}?> />
            <?php } elseif ($_smarty_tpl->tpl_vars['data_id']->value=='s_zipcode') {?>
                <input <?php if ($_smarty_tpl->tpl_vars['field']->value['autocomplete_type']) {?>x-autocompletetype="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['autocomplete_type'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> type="tel" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'UTF-8');?>
elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_name']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="ty-input-text<?php if (($_smarty_tpl->tpl_vars['field']->value['autocomplete_type']=="phone-full")||($_smarty_tpl->tpl_vars['field']->value['field_type']==smarty_modifier_enum("ProfileFieldTypes::PHONE"))) {?> cm-mask-phone<?php }?> <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');
} else { ?>cm-skip-avail-switch<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['profile_fields']['index']==0) {?> cm-focus<?php }?>"  onKeyUp="AjaxZip3.zip2addr(this,'','user_data[s_state]','user_data[s_city]','','user_data[s_address]');" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value) {
echo $_smarty_tpl->tpl_vars['disabled_param']->value;
}?> />
            <?php } elseif ($_smarty_tpl->tpl_vars['data_id']->value=='zipcode') {?>
                <input <?php if ($_smarty_tpl->tpl_vars['field']->value['autocomplete_type']) {?>x-autocompletetype="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['autocomplete_type'], ENT_QUOTES, 'UTF-8');?>
"<?php }?> type="tel" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'UTF-8');?>
elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_name']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="ty-input-text<?php if (($_smarty_tpl->tpl_vars['field']->value['autocomplete_type']=="phone-full")||($_smarty_tpl->tpl_vars['field']->value['field_type']==smarty_modifier_enum("ProfileFieldTypes::PHONE"))) {?> cm-mask-phone<?php }?> <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value) {
echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');
} else { ?>cm-skip-avail-switch<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['profile_fields']['index']==0) {?> cm-focus<?php }?>" onKeyUp="AjaxZip3.zip2addr(this,'','company_data[state]','company_data[city]','','company_data[address]');" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value) {
echo $_smarty_tpl->tpl_vars['disabled_param']->value;
}?> />
            <?php } else { ?>
        <input
...
"<?php }?>
            type=<?php if (($_smarty_tpl->tpl_vars['field']->value['field_type']==smarty_modifier_enum("ProfileFieldTypes::PHONE")||$_smarty_tpl->tpl_vars['data_id']->value=="phone")) {?>"tel"<?php } else { ?>"text"<?php }?>
