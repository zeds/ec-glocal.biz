<?php /* Smarty version Smarty-3.1.21, created on 2022-05-30 21:38:53
         compiled from "/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/common/product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:8701599426294badd1c19a6-76576768%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1b0ee06e19ee7f2db5328bfa61cf5e997a055df0' => 
    array (
      0 => '/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/common/product_data.tpl',
      1 => 1653909591,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '8701599426294badd1c19a6-76576768',
  'function' => 
  array (
  ),
  'variables' => 
  array (
    ...
    'show_descr' => 0,
    'show_old_price' => 0,
    'jp_original_price_for_display' => 0,
    'jp_old_price_tax_desc' => 0,
    'jp_list_price_for_display' => 0,
    'show_price' => 0,
    'hide_add_to_cart_button' => 0,
    'jp_price_for_display' => 0,
    'currencies' => 0,
    'base_currency' => 0,
    'show_clean_price' => 0,
    'show_list_discount' => 0,
    'jp_disable_you_save' => 0,
  ...
  'unifunc' => 'content_6294badd59e121_19694274',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6294badd59e121_19694274')) {function content_6294badd59e121_19694274($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/xb870157/ec-glocal.biz/public_html/app/functions/smarty_plugins/block.hook.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('text_out_of_stock','sku','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','including_tax','old_price','list_price','including_tax','enter_your_price','contact_us_for_price','sign_in_to_view_price','jp_exc_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','jp_availability','items','on_backorder','in_stock','jp_availability','jp_order_allowed','in_stock','on_backorder','jp_availability','quantity','text_cart_min_qty','text_edp_product','text_out_of_stock','sku','select_options','notify_when_back_in_stock','email','enter_email','enter_email','go','including_tax','old_price','list_price','including_tax','enter_your_price','contact_us_for_price','sign_in_to_view_price','jp_exc_tax','you_save','you_save','save_discount','free_shipping','save_discount','save_discount','jp_availability','items','on_backorder','in_stock','jp_availability','jp_order_allowed','in_stock','on_backorder','jp_availability','quantity','text_cart_min_qty','text_edp_product'));
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&(defined('AREA') ? constant('AREA') : null)=="C") {
$_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?>

<?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_data_content")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_data_content"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
} elseif (($_smarty_tpl->tpl_vars['product']->value['out_of_stock_actions']==smarty_modifier_enum("OutOfStockActions::SUBSCRIBE"))) {
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"data-ca-product-notify-stock=""data-ca-product-object-prefix="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');?>
"data-ca-product-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"data-ca-auth-user-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['auth']->value['user_id'], ENT_QUOTES, 'UTF-8');?>
"type="checkbox"class="checkbox cm-switch-availability cm-switch-visibility"name="product_notify"<?php if ($_smarty_tpl->tpl_vars['product_notification_enabled']->value===smarty_modifier_enum("YesNo::YES")) {?>checked="checked"<?php }?>/><?php echo $_smarty_tpl->__("notify_when_back_in_stock");?>
...
echo $_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('option'=>"track_product_in_stock"), 0);
}
...
<?php if ($_smarty_tpl->tpl_vars['show_price_values']->value) {?>
    <?php if ($_smarty_tpl->tpl_vars['settings']->value['Appearance']['show_prices_taxed_clean']=="Y"&&$_smarty_tpl->tpl_vars['product']->value['taxed_price']) {?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['product']->value['clean_price']!=$_smarty_tpl->tpl_vars['product']->value['taxed_price']&&$_smarty_tpl->tpl_vars['product']->value['included_tax']) {?>
            ...
            <?php $_smarty_tpl->tpl_vars["jp_price_for_display"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['taxed_price'], null, 0);?>

            <?php $_smarty_tpl->tpl_vars["jp_disable_you_save"] = new Smarty_variable(true, null, 0);?>

            
            <?php if ($_smarty_tpl->tpl_vars['show_old_price']->value) {?>
                
                <?php if ($_smarty_tpl->tpl_vars['product']->value['discount']) {?>
                    
                    <?php $_smarty_tpl->tpl_vars["jp_original_price_for_display"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['taxed_original_price'], null, 0);?>
                
                <?php } elseif ($_smarty_tpl->tpl_vars['product']->value['list_discount']) {?>
                    
                    <?php $_smarty_tpl->tpl_vars["jp_list_price_for_display"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['taxed_list_price'], null, 0);?>
                <?php }?>
                
                <?php $_smarty_tpl->tpl_vars["jp_old_price_tax_desc"] = new Smarty_variable($_smarty_tpl->__("including_tax"), null, 0);?>
            <?php }?>
        
        <?php } else { ?>
            
            <?php $_smarty_tpl->tpl_vars["jp_price_for_display"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['price'], null, 0);?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['show_old_price']->value) {?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['product']->value['discount']) {?>
                    ...
                    <?php $_smarty_tpl->tpl_vars["jp_original_price_for_display"] = new Smarty_variable((($tmp = @$_smarty_tpl->tpl_vars['product']->value['original_price'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['product']->value['base_price'] : $tmp), null, 0);?>
                
                <?php } elseif ($_smarty_tpl->tpl_vars['product']->value['list_discount']) {?>
                    
                    <?php $_smarty_tpl->tpl_vars["jp_list_price_for_display"] = new Smarty_variable($_smarty_tpl->tpl_vars['product']->value['list_price'], null, 0);?>
                <?php }?>
            <?php }?>
        <?php }?>
...
: <?php }?><span class="ty-strike"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['jp_original_price_for_display']->value,'span_id'=>"old_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value),'class'=>"ty-list-price ty-nowrap"), 0);
if ($_smarty_tpl->tpl_vars['jp_old_price_tax_desc']->value) {?> (<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['jp_old_price_tax_desc']->value, ENT_QUOTES, 'UTF-8');?>
)<?php }?></span></span>
...
:</span> <?php }?><span class="ty-strike"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['jp_list_price_for_display']->value,'span_id'=>"list_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value),'class'=>"ty-list-price ty-nowrap"), 0);
if ($_smarty_tpl->tpl_vars['jp_old_price_tax_desc']->value) {?> (<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['jp_old_price_tax_desc']->value, ENT_QUOTES, 'UTF-8');?>
)<?php }?></span></span>
            <?php }?>
...
echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['jp_price_for_display']->value,'span_id'=>"discounted_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value),'class'=>"ty-price-num"), 0);
if ($_smarty_tpl->tpl_vars['product']->value['clean_price']!=$_smarty_tpl->tpl_vars['product']->value['taxed_price']) {?><span class="ty-price-num"> (<?php echo $_smarty_tpl->__("including_tax");?>
)</span><?php }?></span>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
">(<?php echo $_smarty_tpl->__("jp_exc_tax");?>
 <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['price'],'span_id'=>"product_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value),'class'=>"ty-list-price ty-nowrap"), 0);?>
)</span>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("list_discount_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['show_price_values']->value&&$_smarty_tpl->tpl_vars['show_list_discount']->value&&$_smarty_tpl->tpl_vars['details_page']->value&&!$_smarty_tpl->tpl_vars['jp_disable_you_save']->value) {?>
...
}?>%<?php if ((defined('CART_LANGUAGE') ? constant('CART_LANGUAGE') : null)=='ja') {?>OFF<?php }?></span></span>
                        ...
                        <?php if (($_smarty_tpl->tpl_vars['product_amount']->value>0&&$_smarty_tpl->tpl_vars['product_amount']->value>=$_smarty_tpl->tpl_vars['product']->value['min_qty']||$_smarty_tpl->tpl_vars['product']->value['out_of_stock_actions']==smarty_modifier_enum("OutOfStockActions::BUY_IN_ADVANCE"))&&$_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']!==smarty_modifier_enum("YesNo::NO")) {?>
                            <div class="ty-control-group product-list-field">
                                <?php if ($_smarty_tpl->tpl_vars['show_amount_label']->value) {?>
                                    ...
                                    <label class="ty-control-group__label"><?php echo $_smarty_tpl->__("jp_availability");?>
:</label>
...
&nbsp;<?php echo $_smarty_tpl->__("items");?>
                        ...
                        <?php } elseif ($_smarty_tpl->tpl_vars['settings']->value['General']['inventory_tracking']!==smarty_modifier_enum("YesNo::NO")&&$_smarty_tpl->tpl_vars['settings']->value['General']['allow_negative_amount']!="Y") {?>
                            <div class="ty-control-group product-list-field">
                                <?php if ($_smarty_tpl->tpl_vars['show_amount_label']->value) {?>
...
:</label>
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['allow_negative_amount']=="Y"&&$_smarty_tpl->tpl_vars['product_amount']->value<=0) {?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['out_of_stock_text']->value, ENT_QUOTES, 'UTF-8');
echo $_smarty_tpl->__("jp_order_allowed");?>
</span>
                        <?php } else { ?>
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("capture_product_labels_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, null); ob_start(); ?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['show_discount_label']->value&&($_smarty_tpl->tpl_vars['product']->value['discount_prc']||$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])&&$_smarty_tpl->tpl_vars['show_price_values']->value) {?>
                <?php if ($_smarty_tpl->tpl_vars['product']->value['discount']) {?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp5=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp5." ".((string)$_smarty_tpl->tpl_vars['product']->value['discount_prc'])."%", null, 0);?>
                <?php } else { ?>
                    <?php ob_start();
echo $_smarty_tpl->__("save_discount");
$_tmp6=ob_get_clean();?><?php $_smarty_tpl->tpl_vars['label_text'] = new Smarty_variable($_tmp6." ".((string)$_smarty_tpl->tpl_vars['product']->value['list_discount_prc'])."%", null, 0);?>
                <?php }?>
