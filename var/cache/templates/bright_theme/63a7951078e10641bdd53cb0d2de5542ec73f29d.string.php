<?php /* Smarty version Smarty-3.1.21, created on 2022-06-04 22:33:21
         compiled from "63a7951078e10641bdd53cb0d2de5542ec73f29d" */ ?>
<?php /*%%SmartyHeaderCode:2053060328629b5f21cb4180-59608356%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63a7951078e10641bdd53cb0d2de5542ec73f29d' => 
    array (
      0 => '63a7951078e10641bdd53cb0d2de5542ec73f29d',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '2053060328629b5f21cb4180-59608356',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_629b5f21cb94c1_64530042',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_629b5f21cb94c1_64530042')) {function content_629b5f21cb94c1_64530042($_smarty_tpl) {?><div>
	宿泊施設を選択してください
</div>
...
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H5.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H5()">
	<p>S-H5.一色  キープラン様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H6.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H6()">
	<p>S-H6.久留和  阿部様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y1.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y1()">
	<p>S-Y1.第6  杉崎様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y2.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y2()">
	<p>S-Y2.第1ルームA  杉崎様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y3.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y3()">
	<p>S-Y3.第1ルームB  杉崎様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y4.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y4()">
	<p>S-Y4.県立103  杉崎様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y5.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y5()">
	<p>S-Y5.県立104  杉崎様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z1.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z1()">
	<p>S-Z1.桜山  加藤様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z2.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z2()">
	<p>S-Z2.渚通り  青木様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z3.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z3()">
	<p>S-Z3.なぎさハウス  百田様</p>
</div>
<div style="width: 160px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z4.jpg" width="160px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z4()">
	<p>S-Z4.ハルちゃん  清水様</p>
</div>
...
>
	...
	function S_Y5() {
		...
		document.getElementById('litecheckout_city').value='横須賀市安浦';
		document.getElementById('litecheckout_s_address').value='1-20-3';
		document.getElementById('litecheckout_s_address_2').value='S-Y4.県立104  杉崎様';
	}
	function S_Z1() {
