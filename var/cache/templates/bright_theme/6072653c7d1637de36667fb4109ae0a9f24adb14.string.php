<?php /* Smarty version Smarty-3.1.21, created on 2022-06-04 22:47:23
         compiled from "6072653c7d1637de36667fb4109ae0a9f24adb14" */ ?>
<?php /*%%SmartyHeaderCode:1954747713629b626bc76679-97367625%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '6072653c7d1637de36667fb4109ae0a9f24adb14' => 
    array (
      0 => '6072653c7d1637de36667fb4109ae0a9f24adb14',
      1 => 0,
      2 => 'string',
    ),
  ),
  'nocache_hash' => '1954747713629b626bc76679-97367625',
  'function' => 
  array (
  ),
  'has_nocache_code' => false,
  'version' => 'Smarty-3.1.21',
  'unifunc' => 'content_629b626bc7b3f4_95505334',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_629b626bc7b3f4_95505334')) {function content_629b626bc7b3f4_95505334($_smarty_tpl) {?><div>
	宿泊施設を選択すると、配送先住所が自動入力されます
</div>

<h3>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H1.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H1()">
	<p>S-H1.矢嶋邸  矢嶋様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H2.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H2()">
	<p>S-H2.海風</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H3.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H3()">
	<p>S-H3.ログハウス  宮内様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H4.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H4()">
	<p>S-H4.古民家  宮内様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H5.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H5()">
	<p>S-H5.一色  キープラン様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-H6.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_H6()">
	<p>S-H6.久留和  阿部様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y1.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y1()">
	<p>S-Y1.第6  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y2.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y2()">
	<p>S-Y2.第1ルームA  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y3.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y3()">
	<p>S-Y3.第1ルームB  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y4.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y4()">
	<p>S-Y4.県立103  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Y5.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Y5()">
	<p>S-Y5.県立104  杉崎様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z1.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z1()">
	<p>S-Z1.桜山  加藤様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z2.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z2()">
	<p>S-Z2.渚通り  青木様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z3.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z3()">
	<p>S-Z3.なぎさハウス  百田様</p>
</div>
<div style="width: 170px; color: gray; display: inline-block; _display: inline;">
	<img src="./images/companies/1/施設画像/S-Z4.jpg" width="170px" height="auto" alt="S-H1.矢嶋亭 矢嶋様" onclick="S_Z4()">
	<p>S-Z4.ハルちゃん  清水様</p>
</div>
...
>
	...
	function S_H4() {
		...
		document.getElementById('litecheckout_city').value='三浦郡葉山町堀内';
		document.getElementById('litecheckout_s_address').value='2171-2';
		document.getElementById('litecheckout_s_address_2').value='S-H4.古民家  宮内様';
	}
	function S_H5() {
