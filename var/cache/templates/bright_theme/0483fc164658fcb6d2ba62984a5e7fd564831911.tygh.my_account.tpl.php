<?php /* Smarty version Smarty-3.1.21, created on 2022-05-30 21:04:15
         compiled from "/home/xb870157/ec-glocal.biz/public_html/design/themes/bright_theme/templates/blocks/my_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12148916226294b2bfba5c36-60115203%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0483fc164658fcb6d2ba62984a5e7fd564831911' => 
    array (
      0 => '/home/xb870157/ec-glocal.biz/public_html/design/themes/bright_theme/templates/blocks/my_account.tpl',
      1 => 1653909591,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '12148916226294b2bfba5c36-60115203',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_6294b2bfc39346_41748358',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_6294b2bfc39346_41748358')) {function content_6294b2bfc39346_41748358($_smarty_tpl) {?><?php if (!is_callable('smarty_function_live_edit')) include '/home/xb870157/ec-glocal.biz/public_html/app/functions/smarty_plugins/function.live_edit.php';
...
?><?php
\Tygh\Languages\Helper::preloadLangVars(array('jp_welcome','jp_dear_casual','jp_login_or_register','dear','profile_details','downloads','orders','view_comparison_list','jp_remise_payquick_registered_card','track_my_order','track_my_order','order_id','email','go','go_to_admin_panel','sign_out','sign_in','register','sign_in','jp_welcome','jp_dear_casual','jp_login_or_register','dear','profile_details','downloads','orders','view_comparison_list','jp_remise_payquick_registered_card','track_my_order','track_my_order','order_id','email','go','go_to_admin_panel','sign_out','sign_in','register','sign_in'));
?>
...
">
                    ...
                    <span class="hidden-phone"><?php echo $_smarty_tpl->__("jp_welcome");
...
echo $_smarty_tpl->__("jp_dear_casual");?>
</span>
...
">
                <i class="ty-icon-user"></i>&nbsp;
                <span class="hidden-phone"><?php echo $_smarty_tpl->__("jp_login_or_register");?>
</span>
                <i class="ty-icon-down-micro ty-account-info__user-arrow"></i>
            </a>
        <?php }?>
...
if ($_smarty_tpl->tpl_vars['compared_products']->value) {?> (<?php echo htmlspecialchars(smarty_modifier_count($_smarty_tpl->tpl_vars['compared_products']->value), ENT_QUOTES, 'UTF-8');?>
            ...
            <?php if (fn_lcjp_get_payquick_info($_smarty_tpl->tpl_vars['auth']->value['user_id'])) {?>
                <?php if ($_smarty_tpl->tpl_vars['auth']->value['user_id']&&$_smarty_tpl->tpl_vars['auth']->value['user_id']>0) {?>
                    <li class="ty-account-info__item ty-dropdown-box__item"><a class="ty-account-info__a" href="<?php echo htmlspecialchars(fn_url("remise_card_info.view"), ENT_QUOTES, 'UTF-8');?>
" rel="nofollow" class="underlined"><?php echo $_smarty_tpl->__("jp_remise_payquick_registered_card");?>
</a></li>
                <?php }?>
            <?php }?>
...
--></div>
    ...
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"profiles:jp_auth_links")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"profiles:jp_auth_links"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
">
    ...
    <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"profiles:jp_auth_links"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
