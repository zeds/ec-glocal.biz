<?php /* Smarty version Smarty-3.1.21, created on 2022-05-31 06:24:37
         compiled from "/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/views/checkout/components/cart_items.tpl" */ ?>
<?php /*%%SmartyHeaderCode:708581416629536152ea543-47909308%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b45fc36a561a98361595b07a0fff2d18e46f6163' => 
    array (
      0 => '/home/xb870157/ec-glocal.biz/public_html/design/themes/responsive/templates/views/checkout/components/cart_items.tpl',
      1 => 1653909591,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '708581416629536152ea543-47909308',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_629536153c4a44_25597582',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_629536153c4a44_25597582')) {function content_629536153c4a44_25597582($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/home/xb870157/ec-glocal.biz/public_html/app/functions/smarty_plugins/block.hook.php';
...
">&nbsp;<i class="ty-delete-big__icon ty-icon-cancel-circle"></i></a><?php }?>
                            <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:product_additional_info")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:product_additional_info"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
                                ...
                                <div class="ty-cart-content__sku ty-sku cm-hidden-wrapper<?php if (!$_smarty_tpl->tpl_vars['product']->value['product_code']) {?> hidden<?php }?>" id="sku_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8');?>
">
...
--></span>
                                ...
                                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"checkout:product_options")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"checkout:product_options"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
--></div>
                                    <?php }?>
                                <?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:product_options"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
echo htmlspecialchars($_smarty_tpl->tpl_vars['default_minimal_qty']->value, ENT_QUOTES, 'UTF-8');
} else {
