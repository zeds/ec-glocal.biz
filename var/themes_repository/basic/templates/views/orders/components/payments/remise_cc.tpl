...
<div class="clearfix">
    ...
    {if $payment_method.processor_params.installment == 'true' || $payment_method.processor_params.revo == 'true'}
        <div class="control-group">
            <label for="remese_cc_payment_type" class="cm-required">{__("jp_remise_payment_method")}</label>
    ...
    {if $payment_method.processor_params.payquick == 'true' && $auth.user_id && $auth.user_id > 0}
        <div class="control-group">
            <label for="jp_remise_use_payquick" class="cm-required">{__("jp_remise_use_payquick")}</label>
            <p>
