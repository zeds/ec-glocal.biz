{* $Id: jp_place_order_button.override.tpl by tommy from cs-cart.jp 2013 *}
...
<script src="js/lib/prettyphoto/js/jquery.prettyPhoto.js" type="text/javascript" charset="utf-8"></script>
