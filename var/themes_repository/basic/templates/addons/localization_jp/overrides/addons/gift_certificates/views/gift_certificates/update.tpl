...
<div class="info-field-body {if $runtime.mode == "add" || $gift_cert_data.send_via == "E"}hidden{/if}" id="post_block">
    {if $smarty.const.CART_LANGUAGE == 'ja'}
        ...
        <div class="control-group zipcode">
            ...
            <input type="text" id="gift_cert_zipcode" name="gift_cert_data[zipcode]" class="input-text input-text-short" size="50" value="{$gift_cert_data.zipcode}" onKeyUp="AjaxZip3.zip2addr(this,'','gift_cert_data[state]','gift_cert_data[city]','','gift_cert_data[address]');"/>
        </div>
        ...
        <div class="control-group">
            <label for="gift_cert_address" class="cm-required">{__("jp_address_vendors")}</label>
