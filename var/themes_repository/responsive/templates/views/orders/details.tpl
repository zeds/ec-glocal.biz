                                    ...
                                    {if $use_shipments}
                                        <ul>
                                            {foreach from=$order_info.shipping item="shipping_method"}
                                                ...
                                                {if $use_shipments}
                                                    {assign var="delivery_info" value=$shipping_method}
                                                {else}
                                                    {assign var="delivery_info" value=$shipping}
                                                {/if}

                                                {if $delivery_info.delivery_date}
                                                    <div class="jp_order_delivery_info">{__("jp_delivery_date")} : {$delivery_info.delivery_date}</div>
                                                {/if}

                                                {if $delivery_info.delivery_timing}
                                                    <div class="jp_order_delivery_info">{__("jp_shipping_delivery_time")} : {$delivery_info.delivery_timing}</div>
                                                {/if}
