...
function fn_exim_put_csv(&$data, &$options, $enclosure)
{
    ...
    if ($fd) {
        ///////////////////////////////////////////////////////////////////
        // Modified for Japanese version by ari from cs-cart.jp 2016 BOF
        // エクスポート時の文字コードを変更
        ///////////////////////////////////////////////////////////////////
        fn_set_hook('jp_output_csv_pre', $csv);
        ///////////////////////////////////////////////////////////////////
        // Modified for Japanese version by ari from cs-cart.jp 2016 EOF
        ///////////////////////////////////////////////////////////////////
...
function fn_import($pattern, $import_data, $options)
{
    ...
    foreach ($import_data as $k => $v) {
        ...
        ///////////////////////////////////////////////////////////////////
        // Modified for Japanese version by tommy from cs-cart.jp 2016 BOF
        // オプション別ダウンロードファイル設定用フックを設定
        ///////////////////////////////////////////////////////////////////
        fn_set_hook('jp_import_prepare_group', $v[$main_lang], $pre_inserting_groups, $options, $skip_record, $main_lang, $pattern, $processed_data);
        ///////////////////////////////////////////////////////////////////
        // Modified for Japanese version by tommy from cs-cart.jp 2016 EOF
        ///////////////////////////////////////////////////////////////////
...
function fn_exim_get_field_label($value, $action = '')
{
    ...
    switch($value) {
        ...
        case 'delivery_date':
            $value = "jp_delivery_date";
            break;
        case 'delivery_timing':
            $value = 'jp_shipping_delivery_time';
            break;
    }
    ///////////////////////////////////////////////////////////////
