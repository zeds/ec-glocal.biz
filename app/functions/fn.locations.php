...
function fn_get_all_states($avail_only = true, $lang_code = CART_LANGUAGE)
{
    ...
    // Sort by location (North -> South) if the selected language is "ja"
    ///////////////////////////////////////////////////////////////////////
    if($lang_code == 'ja'){
        return db_get_hash_multi_array("SELECT a.country_code, a.code, b.state FROM ?:states as a LEFT JOIN ?:state_descriptions as b ON b.state_id = a.state_id AND b.lang_code = ?s $avail_cond ORDER BY a.country_code, a.state_id", array('country_code'), $lang_code);
    }else{
