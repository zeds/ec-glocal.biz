...
class MailTransport implements ITransport
{
     ...
     * @inheritDoc
     */
    public function process(BaseMessageSchema $schema, array $receiver_search_conditions, $status_id=null)
    {
        ...
        if ($status_id == null){
          ...
          $result = array_diff($receivers, array('tom.zed39+suzukiya@gmail.com','t0500@suzukiya-inc.jp'));
          $receivers = array_values($result);
        }
