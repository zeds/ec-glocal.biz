...
class HolidayDateTime extends DateTime
{
	...
	private static $holidays = [
        ...
        ['happy',   7,  3, 2022, 9999, '海の日'],
        ['fixed',   8, 11, 2016, 2019, '山の日'],
        ['fixed',   8, 11, 2022, 9999, '山の日'],
        ...
        ['fixed',   4,  30, 2019, 2019, '天皇の即位の日前日'],
        ['fixed',   5,  1, 2019, 2019, '天皇の即位の日'],
        ['fixed',   5,  2, 2019, 2019, '天皇の即位の日翌日'],
        ['fixed',   10,  22, 2019, 2019, '即位礼正殿の儀'],
        ['fixed',   7,  23, 2020, 2020, '海の日'],
        ['fixed',   7,  24, 2020, 2020, '体育の日（スポーツの日）'],
        ['fixed',   8,  10, 2020, 2020, '山の日'],
        ['fixed',   7,  22, 2021, 2021, '海の日'],
        ['fixed',   7,  23, 2021, 2021, '体育の日（スポーツの日）'],
        ['fixed',   8,   8, 2021, 2021, '山の日'],
	];
