...
// お客様が出品者へチャットメッセージを送信した際に送信されるメールで使用可能なテンプレート変数

/////////////////////////////////////////////////////////////////////////////
// データ取得 BOF
/////////////////////////////////////////////////////////////////////////////
// お客様情報
$tpl_user_data = $tpl_base_data['message_from']->value;
...
$mail_tpl_var =
    array(
        'U_NAME' =>
            array('desc' => 'user_name',
                'value' => html_entity_decode($tpl_user_data, ENT_QUOTES, 'UTF-8') ),
        'URL' =>
            array('desc' => 'url',
