...
// $Id: profiles_update_profile.php by tommy from cs-cart.jp 2015
// 会員情報の更新メールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_profiles_update_profile', $mail_tpl_var, $tpl_user_data, $tpl_general_settings, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
