...
// $Id: companies_accounting_new_payout.php by takahashi from cs-cart.jp 2017
// 出品者入出金管理：支払発行メールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_companies_accounting_new_payout', $mail_tpl_var, $tpl_payment_data, $tpl_account_url, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
