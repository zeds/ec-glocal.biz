...
//
// $Id: profiles_profile_activated.php by tommy from cs-cart.jp 2015
// 会員アカウントが有効化された際に送信されるメールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_profiles_profile_activated', $mail_tpl_var, $tpl_user_data, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
