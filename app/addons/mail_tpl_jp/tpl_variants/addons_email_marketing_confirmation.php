...
// $Id: addons_email_marketing_confirmation.php by tommy from cs-cart.jp 2015
// ダブルオプトイン方式のメルマガに対して購読申込みが行われた際に送信されるメールで使用可能なテンプレート変数
...
$mail_tpl_var = array(
	'CONFIRMATION_URL' =>
		array('desc' => 'mtpl_email_marketing_subscription_url',
			'value' => empty($_edit_mail_tpl) ? $tpl_url : ''),
);

if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_addons_email_marketing_confirmation', $mail_tpl_var, $tpl_url);
}
/////////////////////////////////////////////////////////////////////////////
