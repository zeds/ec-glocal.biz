...
// $Id: addons_email_marketing_welcome.php by tommy from cs-cart.jp 2015
// メルマガ購読受付完了時に送信されるメールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_addons_email_marketing_welcome', $mail_tpl_var, $tpl_url);
}
/////////////////////////////////////////////////////////////////////////////
