...
// $Id: profiles_usergroup_disactivation.php by tommy from cs-cart.jp 2016
// ユーザーグループが無効化された際に送信されるメールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_profiles_usergroup_disactivation', $mail_tpl_var, $tpl_user_data, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
