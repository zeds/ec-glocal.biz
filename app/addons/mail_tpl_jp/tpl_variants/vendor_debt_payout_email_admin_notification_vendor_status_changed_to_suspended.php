...
// $Id: vendor_debt_payout_email_admin_notification_vendor_status_changed_to_suspended.php by takahashi from cs-cart.jp 2021
// 出品者債務管理アドオンで出品者のステータスが一時停止となった場合に有効なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
    fn_set_hook('mail_tpl_var_vendor_debt_payout_email_admin_notification_vendor_status_changed_to_suspended', $mail_tpl_var, $tpl_company, $tpl_reason, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
