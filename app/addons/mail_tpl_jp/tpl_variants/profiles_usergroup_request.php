...
// $Id: profiles_usergroup_request.php by tommy from cs-cart.jp 2015
// ユーザーグループへの登録依頼が行われた際に送信されるメールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	...
	// ユーザーグループに関するデータ
	$tpl_usergroup_data = $tpl_base_data['usergroup']->value;

	// 一般設定に関するデータ
	$tpl_general_settings = Registry::get('settings.General');
}
/////////////////////////////////////////////////////////////////////////////
// データ取得 EOF
/////////////////////////////////////////////////////////////////////////////
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_profiles_usergroup_request', $mail_tpl_var, $tpl_user_data, $tpl_general_settings, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
