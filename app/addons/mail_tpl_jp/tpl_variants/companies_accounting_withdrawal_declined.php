...
// $Id: companies_accounting_withdrawal_declined.php by takahashi from cs-cart.jp 2017
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_companies_accounting_withdrawal_declined', $mail_tpl_var, $tpl_payment_data, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
