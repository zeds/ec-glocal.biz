...
// $Id: companies_accounting_payout_approved.php by takahashi from cs-cart.jp 2017
// 出品者入出金管理：支払完了メールで使用可能なテンプレート変数
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_companies_accounting_payout_approved', $mail_tpl_var, $tpl_payment_data, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
