...
// Modified to fix bug by tommy from cs-cart 2017
// 決済ステータスが「Completed-Funds-Held」のケースに対応
// Modified by takahashi from cs-cart.jp 2017
// Paypal Express Checkoutで会員情報フィールドに配送先住所の国名がないときにエラーが出るバグを修正
...
function fn_paypal_get_shipping_data($data)
{
    ...
    if (!empty($data) && !empty($data['s_address']) && !empty($data['s_city'])) {
        ...
        // 日本語版は 姓 = firstname / 名 = lastname で処理している。
        // Paypalに送信する際には姓名を逆にして送信する。
        ///////////////////////////////////////////////////////////////
...
function fn_paypal_set_express_checkout($payment_id, $order_id = 0, $order_info = [], $cart = [], $area = AREA)
{
    ...
    ///////////////////////////////////////////////////////////////
    // Modified for Japanese Ver by takahashi from cs-cart.jp 2017 BOF
    // Paypal Express Checkoutで会員情報フィールドに配送先住所の国名がないときにエラーが出るバグを修正
    ///////////////////////////////////////////////////////////////
    if(!$request['PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE']){
        $request['PAYMENTREQUEST_0_SHIPTOCOUNTRYCODE'] = 'JP';
    }
    ///////////////////////////////////////////////////////////////
    // Modified for Japanese Ver by takahashi from cs-cart.jp 2017 EOF
    ///////////////////////////////////////////////////////////////
