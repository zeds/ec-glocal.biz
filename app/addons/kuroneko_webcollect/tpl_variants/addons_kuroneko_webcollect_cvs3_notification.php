...
// $Id: addons_kroneko_webcollect_cvs3_notification.php by tommy from cs-cart.jp 2016
// コンビニ支払い（ローソン/サークルKサンクス/ミニストップ/セイコーマート）のお支払い情報通知メールで使用可能なテンプレート変数
...
if( $_edit_mail_tpl ){
	...
	$buyer_tel = substr(preg_replace("/[^0-9]+/", "", mb_convert_kana($tpl_order_info['phone'],"a")), 0, 11);
...
$mail_tpl_var =
	array(
		...
		'ECON_NO' =>
			array('desc' => 'jp_kuroneko_webcollect_cvs_econ_no',
				'value' => empty($_edit_mail_tpl) ? $tpl_cvs_payment_info['econNo'] : ''),
		'PHONE' =>
			array('desc' => 'phone',
				'value' => empty($_edit_mail_tpl) ? $buyer_tel : ''),
		'EXPIRY_DATE' =>
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_addons_kuroneko_webcollect_cvs3_notification', $mail_tpl_var, $tpl_order_info, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
