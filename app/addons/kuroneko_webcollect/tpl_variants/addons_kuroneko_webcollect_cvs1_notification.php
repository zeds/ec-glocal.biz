...
// $Id: addons_kroneko_webcollect_cvs1_notification.php by tommy from cs-cart.jp 2016
// コンビニ支払い（セブンイレブン）のお支払い情報通知メールで使用可能なテンプレート変数
...
$mail_tpl_var =
	array(
		...
		'BILLING_NO' =>
			array('desc' => 'jp_kuroneko_webcollect_cvs_billing_no',
				'value' => empty($_edit_mail_tpl) ? $tpl_cvs_payment_info['billingNo'] : ''),
		'BILLING_URL' =>
			array('desc' => 'jp_kuroneko_webcollect_cvs_billing_url',
				'value' => empty($_edit_mail_tpl) ? $tpl_cvs_payment_info['billingUrl'] : ''),
		'EXPIRY_DATE' =>
...
if( empty($_edit_mail_tpl) ) {
	fn_set_hook('mail_tpl_var_addons_kuroneko_webcollect_cvs1_notification', $mail_tpl_var, $tpl_order_info, $mail_template);
}
/////////////////////////////////////////////////////////////////////////////
