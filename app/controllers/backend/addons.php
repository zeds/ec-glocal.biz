...
if ($mode === 'update') {
    ...
    if (!empty($addon_info['supplier'])){
        list($addon_info['support'], $supported_lang_code) = fn_lcjp_get_addons_support_links($addon_info['supplier'], $addon_info['addon']);
    }
    ///////////////////////////////////////////////
    ...
    if (isset($marketplace_product_id)) {
        ...
        $lng = Languages::getSimpleLanguages();
        if($supported_lang_code == 'en'){
            $lng = [
                'en' => __("English")
            ];
        }
        $view->assign('addon_languages', $lng);
        ///////////////////////////////////////////////
        // Modified by takahashi from cs-cart.jp 2021 EOF
        ///////////////////////////////////////////////
    }
