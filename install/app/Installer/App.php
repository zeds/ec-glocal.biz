...
class App
{
    ...
    const DEFAULT_LANGUAGE = 'ja'; // Modified for Japanese Version by takahashi from cs-cart.jp 2021
    const PRIMARY_CURRENCY = 'JPY'; // Modified for Japanese Version by takahashi from cs-cart.jp 2021
    ...
    // インストーラーのデフォルト言語を英語(en)から日本語(ja)に変更
    private $_current_lang_code = 'ja';
    ...
    public function getProductName()
    {
        ...
        if (PRODUCT_EDITION == 'MULTIVENDOR') {
            $product_name = 'CS-Cartマーケットプレイス版';
        } else {
