    ...
    <?php if (!empty($_tpl_vars['show_requirements_section'])): ?>
        ...
        <?php if ($status || $_tpl_vars['extensions']): ?>
            <div class="settings checking-result">
                ...
                <?php endif; ?>
                <?php // Modified by tommy from cs-cart.jp 2017 BOF ?>
                <?php if (empty($_tpl_vars['checking_result']['ftp_connect_available'])): ?>
                    <div class="requirement">
                        <span class="label label-important pull-right"><?php echo $this->t('fail'); ?></span>
                        <strong><?php echo $this->t('ftp_connect_must_be_enabled'); ?></strong><br>
                    </div>
                <?php endif; ?>
                <?php // Modified by tommy from cs-cart.jp 2017 EOF ?>
            </div>
        <?php endif; ?>
    ...
    <div class="setting-wrap">
        <div class="settings">
            <div class="requirement">
                ...
                <?php // Modified by tommy from cs-cart.jp 2017 BOF ?>
                <input type="hidden" name="cart_settings[main_language]" value="ja">
                <?php // Modified by tommy from cs-cart.jp 2017 EOF ?>
                    ...
                    <div class="control-group control-group-last language-choice">
                        ...
                        <div class="controls">
                            <?php foreach ($_tpl_vars['languages'] as $lang_code => $language): ?>
                                <?php // Modified by tommy from cs-cart.jp 2017 BOF ?>
                                <label class="checkbox"><input class="cm-additional-lang-item" id="additional_lang_<?php echo $lang_code;?>" type="checkbox" name="cart_settings[languages][]" value="<?php echo $lang_code;?>"<?php if ($this->prepareVar($_tpl_vars, 'cart_settings.main_language', 'string') == $lang_code || $lang_code == 'ja'): ?>checked="checked" data-ca-auto-ticked="true" disabled="disabled" <?php endif; ?>><?php echo $language; ?></label>
                                <?php // Modified by tommy from cs-cart.jp 2017 EOF ?>
                            <?php endforeach; ?>
                        </div>
                    </div>
