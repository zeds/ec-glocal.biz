 ...
 */
$config['db_host'] = 'mysql105.xbiz.ne.jp';
$config['db_name'] = 'xb870157_ecglocal';
$config['db_user'] = 'xb870157_mekuma';
$config['db_password'] = 'jb942266';
...
$config['http_host'] = 'ec-glocal.biz';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'ec-glocal.biz';
$config['https_path'] = '';
