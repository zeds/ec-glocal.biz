...
<div class="control-group">
    <label for="jp_paygent_cvs_name" class="control-group__title cm-required">{__('jp_paygent_select_cvs')}</label>
...
{if $payment_method.processor_params.paygent_postpay == 'true'}
    <div class="control-group hidden" id="display_paygent_cvs_payment_timing">
        <label for="jp_paygent_cvs_payment_timing" class="control-group__title cm-required">{__("jp_paygent_cvs_payment_timing")}:</label>
        <p>
