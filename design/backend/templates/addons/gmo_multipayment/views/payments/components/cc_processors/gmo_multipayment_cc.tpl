{* $Id: gmo_multipayment_cc.tpl by tommy from cs-cart.jp 2015 *}

<p>{__("jp_gmo_multipayment_cc_notice")}</p>
<hr />
...
<div id="gmomp_cc_payment_settings" class="in collapse">
    <fieldset>
        ...
        <div class="control-group">
            <label class="control-label" for="use_uid">{__('jp_gmo_multipayment_cc_register_card_info')}:</label>
            <div class="controls">
