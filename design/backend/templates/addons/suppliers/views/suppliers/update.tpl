...
{* 国名を変更後に都道府県のテキストボックスが表示されないバグを修正 *}
                ...
                <fieldset>
                    ...
                    {hook name="suppliers:general_information"}
                        ...
                        {if $smarty.const.CART_LANGUAGE == 'ja'}
                            {include file="common/subheader.tpl" title=__("jp_company_address")}
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="supplier_data[zipcode]" id="elm_supplier_zipcode" size="32" value="{$supplier.zipcode}" onKeyUp="AjaxZip3.zip2addr(this,'','supplier_data[state]','supplier_data[city]','','supplier_data[address]');" />
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    ...
                                    {* 国名を変更後に都道府県のテキストボックスが表示されないバグを修正 *}
                                    <select id="elm_supplier_state{if !$states.$_country}_d{/if}" name="supplier_data[state]" class="cm-state cm-location-shipping {if !$states.$_country}hidden{/if}">
                                    ...
                                    {* Modified by takahashi from cs-cart.jp 2022 BOF *}
                                    {* 国名を変更後に都道府県のテキストボックスが表示されないバグを修正 *}
                                    <input type="text" id="elm_supplier_state{if $states.$_country}_d{/if}" name="supplier_data[state]" size="32" maxlength="64" value="{$_state}" {if $states.$_country}disabled="disabled"{/if} class="cm-state cm-location-shipping {if $states.$_country}hidden{/if} cm-skip-avail-switch" />
                                    {* Modified by takahashi from cs-cart.jp 2022 EOF *}
                                </div>
                            </div>
