...
{capture name="mainbox"}
    ...
    {capture name="sidebar"}
        {include file="addons/kuroneko_webcollect/views/krnkwc_cvs_manager/components/orders_search_form.tpl" dispatch="krnkwc_cvs_manager.manage"}
    {/capture}

    <form action="{""|fn_url}" method="post" target="_self" name="krnkwc_cvs_orders_list_form">
        ...
        {assign var="page_title" value=__("jp_kuroneko_webcollect_cvs_order_status_long")}
                    ...
                    <tr>
                        ...
                        <td width="5%" class="center">
                            {capture name="tools_items"}
                                ...
                                <li><a class="cm-confirm" href="{"krnkwc_cvs_manager.wc_check_status?order_id=`$o.order_id`&amp;redirect_url=`$current_redirect_url`"|fn_url}">{__("jp_kuroneko_webcollect_check_wc_order_status")}</a></li>
                            {/capture}
