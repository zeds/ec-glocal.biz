{* $Id: krnkwc_cc.tpl by tommy from cs-cart.jp 2016 *}
    ...
    <div class="clearfix">
        <div class="credit-card">
            ...
            <div class="control-group">
                ...
                <div class="controls clear">
                    <input size="35" type="text" id="credit_card_name_{$id_suffix}" name="payment_info[card_owner]" value="" class="cm-cc-name ty-credit-card__input ty-uppercase" />
                </div>
            </div>            
