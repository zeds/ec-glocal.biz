        ...
        <div class="sidebar-row">
            ...
            <form action="{''|fn_url}" name="orders_search_form" method="get" class="{$form_meta}">
                ...
                {capture name='advanced_search'}
                    ...
                    <div class="group">
                        {if $incompleted_view}
                            <input type="hidden" name="is_charge" value="" />
                        {else}
                            <div class="control-group">
                                <label class="control-label">{__('sbps_is_charge')}</label>
                                <div class="controls checkbox-list">
                                    {include file='addons/ap_sbps/views/ap_sbps_rb_credit_manager/components/is_charge.tpl' checked_is_charge=$search.is_charge name='is_charge'}
                                </div>
                            </div>
                        {/if}
                    </div>
