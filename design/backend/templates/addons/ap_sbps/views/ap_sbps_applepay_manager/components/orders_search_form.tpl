            ...
            <form action="{''|fn_url}" name="orders_search_form" method="get" class="{$form_meta}">
                ...
                {capture name='advanced_search'}
                    ...
                    <div class="group">
                        ...
                        {else}
                            <div class="control-group">
                                <label class="control-label">{__('sbps_payment_status')}</label>
                                <div class="controls checkbox-list">
                                    {include file='addons/ap_sbps/views/ap_sbps_applepay_manager/components/payment_status.tpl' checked_status=$search.payment_status name='payment_status'}
                                </div>
                            </div>
                        {/if}
                    </div>
