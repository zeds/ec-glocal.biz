        ...
        <p class="strong">
            ...
            {if $smarty.const.CART_LANGUAGE == 'ja'}
                {if $user_data.user_id}
                    <a href="{"profiles.update?user_id=`$user_data.user_id`"|fn_url}">{$user_data.firstname} {$user_data.lastname} {__("dear")}</a>
                {else}
                    {$user_data.firstname} {$user_data.lastname} {__("dear")}
                {/if}
            {else}
            {if $user_data.user_id}
