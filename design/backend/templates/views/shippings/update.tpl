...
<div class="control-group">
    <label class="control-label">{__("jp_delivery_date_specify")}</label>
    <input type="hidden" name="delivery_id" value="{$delivery_date.delivery_id}" />
    <div class="controls">
        <label class="checkbox inline" for="elm_delivery_status">
            <input type="checkbox" name="delivery_status" id="elm_delivery_status" {if $delivery_date.delivery_status=="1"}checked="checked"{/if} class="checkbox" value="1" />{__("jp_delivery_date_enable")}
        </label>
    </div>
</div>

<div class="control-group">
    <label class="control-label">{__("jp_delivery_date_display_days")}:</label>
    <div class="controls">
        {__("jp_delivery_date_desc01")}&nbsp;<input name="delivery_from" class="input-mini" type="text" size="3" value="{$delivery_date.delivery_from}" />&nbsp;{__("jp_delivery_date_desc02")}
        <input type="checkbox" name="include_holidays" id="include_holidays" {if $delivery_date.include_holidays=="1"}checked="checked"{/if} class="checkbox" value="1" />&nbsp;{__("jp_delivery_date_include_holidays")}）{__("jp_delivery_date_desc03")}&nbsp;<input name="delivery_to" class="input-mini" type="text" size="3" value="{$delivery_date.delivery_to}" />&nbsp;{__("jp_delivery_date_desc04")}
    </div>
</div>
