...
<div class="table-responsive-wrapper">
    <table width="100%" class="table table-middle table--relative table-responsive">
        ...
        <tr>
            ...
            <td data-th="{__("user")}"><a href="{"profiles.update?user_id=`$ug_request.user_id`"|fn_url}">{if $smarty.const.CART_LANGUAGE == 'ja'}{$ug_request.firstname} {$ug_request.lastname}{else}{$ug_request.lastname} {$ug_request.firstname}{/if}</a></td>
