                    ...
                    {if $order_info.shipping}
                        ...
                        {foreach from=$order_info.shipping item="shipping" key="shipping_id" name="f_shipp"}
                            ...
                            {else}
                                ...
                                {/hook}
                                {* Modified by tommy from cs-cart.jp 2017 *}
                                {hook name="orders:jp_post_shipping_info"}{/hook}
                                <hr>
                            {/if}
                            {* Modified by tommy from cs-cart.jp 2017 BOF *}
                            {if $shipping.delivery_date != ""}
                                <div class="control-group">
                                    <div class="control-label">{__("jp_delivery_date")}</div>
                                    <div id="tygh_jp_delivery_date" class="controls">
                                        {$shipping.delivery_date}
                                    </div>
                                </div>
                            {/if}
                            {if $shipping.delivery_timing != ""}
                                <div class="control-group">
                                    <div class="control-label">{__("jp_shipping_delivery_time")}</div>
                                    <div id="tygh_jp_shipping_delivery_time" class="controls">
                                        {$shipping.delivery_timing}
                                    </div>
                                </div>
                            {/if}
