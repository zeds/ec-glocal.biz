{* $Id: smbc_cctkn.tpl by tommy from cs-cart.jp 2015 *}
...
<div class="clearfix">
    <div class="credit-card">
        ...
        <div class="control-group cvv-field">
            <label for="cc_cvv2{$id_suffix}" class="control-label cm-integer cm-autocomplete-off">{__("jp_smbc_security_code")}</label>
            <div class="controls">
                ...
                <div class="cvv2">{__("jp_smbc_what_is_security_code")}
                    <div class="popover fade bottom in">
                        <div class="arrow"></div>
                        <h3 class="popover-title">{__("jp_smbc_what_is_security_code")}</h3>
        ...
        <div class="control-group hidden" id="display_smbc_cc_split_count">
...
<script>
    ...
    function fn_check_smbc_cc_payment_type(payment_type)
    {
        if (payment_type == '61') {
            (function ($) {
                $(document).ready(function() {
                    $('#display_smbc_cc_split_count').switchAvailability(false);
                });
            })(jQuery);
        } else {
            (function ($) {
                $(document).ready(function() {
                    $('#display_smbc_cc_split_count').switchAvailability(true);
                });
            })(jQuery);
        }
    }
