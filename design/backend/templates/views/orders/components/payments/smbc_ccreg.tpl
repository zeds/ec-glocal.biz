...
<div class="clearfix">
    ...
    <div class="credit-card">
        <div class="control-group">
            <label for="registered_cc_number{$id_suffix}" class="control-label">{__("card_number")}</label>
            <div class="controls">{$registered_card.card_number}</div>
        </div>
        ...
        <div class="control-group">
            <label for="jp_cc_method" class="control-label cm-required">{__("jp_cc_method")}</label>
            <div class="controls">
