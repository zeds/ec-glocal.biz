    ...
    <div id="content_tab_general">
        ...
        <div class="table-responive-wrapper">
            ...
            {foreach from=$order_info.products item="product" key="key"}
                ...
                <tr>
                    <td data-th="{__("product")}">
                        ...
                        {if $may_display_product_update_link && !$product.deleted_product}
                            <a href="{"products.update?product_id=`$product.product_id`"|fn_url}">
                        {/if}

                        {$product.product|default:__("deleted_product") nofilter}
                    ...
                    <td class="center" nowrap="nowrap" data-th="{__("quantity")}">
            ...
            {if !$shipment_products}
                <tr>
                    <td colspan="2" data-th="">{__("no_products_for_shipment")}</td>
                </tr>
            {/if}
        ...
        <fieldset>
            ...
            {hook name="shipments:jp_new_shipment"}
            <div class="control-group">
