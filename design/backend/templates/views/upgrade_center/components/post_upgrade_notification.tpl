...
{$changelog_url = $config.resources.changelog_url|default:"https://docs.cs-cart.com/latest/history/index.html"}
<div class="well">
...
{if !empty($notifications.required) || !empty($notifications.important)}
