    ...
    {if !$runtime.company_id || $runtime.company_id && $product_data.company_id == $runtime.company_id}        
        <div class="pull-right">
            ...
            <span class="shift-right">
                ...
                {include file="common/popupbox.tpl" id="add_new_subscribers" text=__("jp_back_in_stock_add_email") content=$smarty.capture.new_email_picker link_text=__("jp_back_in_stock_add_email") act="general" icon="icon-plus"}
