...
<form action="{""|fn_url}" method="post" enctype="multipart/form-data" name="global_update_form" class="form-horizontal form-edit">
...
{if !($runtime.company_id && "ULTIMATE"|fn_allowed_for)}
    ...
    <div class="control-group">
        <label for="gu_in_stock" class="control-label">{__("jp_inventory_count")}</label>
        <div class="controls">
