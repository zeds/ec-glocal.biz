{* Modified for Japanese Ver by tommy from cs-cart.jp 2021 *}
{* ショッピングモール版用にフックポイント storefronts:tabsbox_post を追加 *}
...
{capture name="mainbox"}
    {capture name="tabsbox"}
        ...
        >
            ...
            {* Modified for Japanese Ver by tommy from cs-cart.jp 2021 BOF *}
            {* ショッピングモール版用にフックポイント storefronts:tabsbox_post を追加 *}
            {hook name="storefronts:tabsbox_post"}{/hook}
            {* Modified for Japanese Ver by tommy from cs-cart.jp 2021 EOF *}
        </form>
    {/capture}
