...
{* トークン決済に対応 form id="jp_payments_form_id" を追加 *}
...
<form id="jp_payments_form_id" action="{""|fn_url}" method="post" class="admin-content-external-form" name="om_cart_form" enctype="multipart/form-data">
