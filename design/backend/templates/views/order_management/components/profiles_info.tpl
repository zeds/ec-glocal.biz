...
{capture name="billing_address"}
    ...
    {* Modified by tommy from cs-cart.jp 2016 BOF *}
    {if $smarty.const.CART_LANGUAGE == 'ja'}
        {if !fn_is_empty($user_data)}
            {if $profile_fields.B}
                {if $user_data.b_firstname || $user_data.b_lastname}
                    <p class="strong">{$user_data.b_firstname} {$user_data.b_lastname} {__("dear")}</p>
                {/if}
                ...
                {if $user_data.b_city || $user_data.b_state_descr || $user_data.b_zipcode}
                    {$user_data.b_zipcode}<p>{$user_data.b_state_descr} {$user_data.b_city}</p>
                {/if}
                ...
                {if $user_data.b_phone}
                    <p>{__("phone")}:{$user_data.b_phone}</p>
                {/if}
            {else}
    ...
    {/if}
    {/if}
    {* Modified by tommy from cs-cart.jp 2016 EOF *}
    {/hook}
{/capture}
        ...
        {if !fn_is_empty($user_data)}
            {if $profile_fields.S}
                {if $user_data.s_firstname || $user_data.s_lastname}
                    <p class="strong">{$user_data.s_firstname} {$user_data.s_lastname} {__("dear")}</p>
                {/if}
                ...
                {if $user_data.s_city || $user_data.s_state_descr || $user_data.s_zipcode}
                    {$user_data.s_zipcode}<p>{$user_data.s_state_descr}{$user_data.s_city}</p>
                {/if}
                ...
                {if $user_data.s_phone}
                    <p>{__("phone")}:{$user_data.s_phone}</p>
                {/if}
            ...
            {if $user_full_name}
                ...
                {if $smarty.const.CART_LANGUAGE == 'ja'}
                    {if $user_data.user_id}
                        <a href="{"profiles.update?user_id=`$user_data.user_id`"|fn_url}">{$user_full_name} {__("dear")}</a>
                    {elseif $user_full_name}
                        {$user_full_name} {__("dear")}
                    {/if}
                {else}
                {if $user_data.user_id}
