<p>{__('sbps_link_notice')}</p>
<p>{__("jp_sbps_notice")}</p>
<hr />
{include file="common/subheader.tpl" title=__('sbps_connections_settings') target="#ap_sbps_link_connection_settings"}
<div id="ap_sbps_link_connection_settings" class="in collapse">
    <fieldset>
        ...
        <div class="control-group">
            ...
            <div class="controls checkbox-list">
                {foreach from=$smarty.const.SBPS_PAY_METHODS item=value}
                    <label>
