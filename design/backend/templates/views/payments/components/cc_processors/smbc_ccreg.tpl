{* $Id: smbc_ccreg.tpl by tommy from cs-cart.jp 2013 *}

<p>{__("jp_smbc_ccreg_notice")}</p>
<hr />
{include file="common/subheader.tpl" title=__("jp_smbc_connections_settings") target="#smbc_ccreg_connection_settings"}
<div id="smbc_ccreg_connection_settings" class="in collapse">
    <fieldset>
...
{include file="common/subheader.tpl" title=__("jp_smbc_cc_payment_settings") target="#smbc_ccreg_payment_settings"}
<div id="smbc_ccreg_payment_settings" class="in collapse">
    <fieldset>
        <div class="control-group">
