...
{if $payment.storefront_owner_id}
    {$storefront_owner_id = $payment.storefront_owner_id}
{/if}
...
<div class="tabs cm-j-tabs">
    <ul class="nav nav-tabs">
        ...
        <li id="tab_conf_{$id}" class="cm-js cm-ajax {if !$payment.processor_id}hidden{/if}"><a {if $payment.processor_id}href="{"payments.processor?payment_id=`$id`"|fn_url}"{/if}>{__("specific_settings")}</a></li>
