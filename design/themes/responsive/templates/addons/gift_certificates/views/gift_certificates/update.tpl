    ...
    <div class="ty-gift-certificate__block{if $runtime.mode == "add" || $gift_cert_data.send_via == "E"} hidden{/if}" id="post_block">
        ...
        {if $smarty.const.CART_LANGUAGE == 'ja'}
            ...
            <div class="ty-control-group ty-billing-zip-code">
                ...
                <input type="tel" id="gift_cert_zipcode" name="gift_cert_data[zipcode]" class="ty-input-text" size="10" value="{$gift_cert_data.zipcode}" onKeyUp="AjaxZip3.zip2addr(this,'','gift_cert_data[state]','gift_cert_data[city]','','gift_cert_data[address]');"/>
            </div>

            {$_state = $gift_cert_data.state|default:$settings.Checkout.default_state}
            <div class="ty-control-group state">
            ...
            <div class="ty-control-group">
                <label for="gift_cert_address_2" class="ty-control-group__title">{__("address_2")}</label>
            ...
            <div class="ty-control-group">
                ...
                <input type="text" id="gift_cert_phone" name="gift_cert_data[phone]" class="ty-input-text-medium cm-mask-phone" size="50" value="{$gift_cert_data.phone}" />
            </div>
        {else}
        <div class="ty-control-group">
            <label for="gift_cert_phone" class="ty-control-group__title cm-mask-phone-label">{__("phone")}</label>
