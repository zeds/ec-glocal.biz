...
<div class="buttons-container cm-confirm">
	{include file="buttons/button.tpl" but_text=__("jp_paygent_ccreg_delete_card_info") but_href="paygent_card_info.delete"}
</div>

{else}
	<p class="no-items">{__("jp_paygent_ccreg_no_card_info")}</p>
{/if}

{capture name="mainbox_title"}{__("jp_paygent_ccreg_registered_card")}{/capture}
