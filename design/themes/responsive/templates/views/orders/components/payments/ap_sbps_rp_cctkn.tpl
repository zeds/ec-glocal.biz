...
<div class="clearfix cc_form_jp">
    <div class="ty-credit-card cm-cc_form_{$id_suffix}">
        ...
        {if $rp_processor_params.use_cvv == 'true'}
            <div class="ty-credit-card__control-group ty-control-group">
...
<script type="text/javascript" src="{$token_js_url[$rp_processor_params.mode]}"></script>
<script type="text/javascript">
    ...
    Tygh.$.ceFormValidator('registerValidator', {
        ...
        func: function(id) {
            ...
            //カードイメージの調整
            if(flag || ('{$rp_processor_params.mode}' === 'test' && input.value.length > 0)) {
    ...
    function submitHandler(e) {
        ...
        if(is_form_val && !is_submit) {
            ...
            com_sbps_system.generateToken({
                merchantId : '{$rp_processor_params.merchant_id}',
                serviceId : '{$rp_processor_params.service_id}',
