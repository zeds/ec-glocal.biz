            ...
            <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto; padding: 0px 40px 40px 40px; width: 510px;" align="left">
                ...
                <tr valign="top">
                    <td style="width: 50%; padding: 14px 0px 0px 2px;">
                        ...
                        {hook name="rma:jp_rma_slip_company_info"}
                        ...
                        <tr>
                            ...
                            <td width="100%"><bdi>{$company_data.company_phone}</bdi></td>
                        </tr>
                        {/if}
                ...
                {if $profile_fields}
                {* Modified by tommy from cs-cart.jp 2017 BOF *}
                {hook name="rma:jp_rma_slip_address_info"}
                ...
                <tr valign="top">
                    ...
                    <td width="33%">
                        ...
                        <p style="margin: 2px 0px 3px 0px;"><span style="text-transform: uppercase;">{__("phone")}:</span>&nbsp;<bdi>{$order_info.phone}</bdi></p>
