        ...
        <td style="background-color: #ffffff; border: 1px solid #e6e6e6; margin: 0px auto 0px auto; padding: 0px 44px 0px 46px; text-align: left;">
            ...
            <tr valign="top">
                ...
                <td style="width: 50%; padding: 14px 0px 0px 2px; font-size: 12px; font-family: Arial;">
                    ...
                    <tr valign="top">
                        ...
                        <td width="100%" style="font-size: 12px; font-family: Arial;"><bdi>{$company_data.company_phone}</bdi></td>
                    </tr>
                    {/if}
            ...
            <tr valign="top">
                ...
                <td width="33%" style="font-size: 12px; font-family: Arial;">
                    ...
                    {if $profields_c.phone}<p style="margin: 2px 0px 3px 0px;"><span style="text-transform: uppercase;">{__("phone")}:</span>&nbsp;<bdi>{$order_info.phone}</bdi></p>{/if}
                ...
                <td width="34%" style="font-size: 12px; font-family: Arial; {if $profile_fields.S}padding-right: 10px;{/if} {if $profile_fields.C}padding-left: 10px;{/if}">
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        {if $profields_b.b_phone}<bdi>{$order_info.b_phone}</bdi> {/if}
                    </p>
                    {/if}
                ...
                <td width="33%" style="font-size: 12px; font-family: Arial;">
                    ...
                    <p style="margin: 2px 0px 3px 0px;">
                        {if $profields_s.s_phone}<bdi>{$order_info.s_phone}</bdi> {/if}
                    </p>
                    {/if}
            ...
            {hook name="orders:jp_invoice_hide_tax"}
            ...
            <tr>
                ...
                {/foreach}
                {/if}
                {hook name="orders:invoice_taxes"}
                {if $order_info.taxes}
                <tr>
